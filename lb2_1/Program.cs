...
namespace lb2_1
{
    ...
    */
    ...
    public class Program
    {
        ...
        {
            return int.TryParse(Console.ReadLine(), out i);
        }
        ...
        public static void sortIntArray(int[] array, bool ascending_order)
        {
            int n_swaps = 1;
            while (n_swaps != 0)
            {
        ...
        static void Main()
        {
            ...
            int n = readInt("Enter n (integer, 0 < n):", pozitiveInt);
            int[] a = new int[n];
            for (int i = 0; i < n; ++i)
            {
                a[i] = readInt("Enter a[" + i.ToString() + "] (integer):", anyInt);
            }

            int m = readInt("Enter m (integer, 0 < m):", pozitiveInt);
            int[] b = new int[m];
            for (int i = 0; i < m; ++i)
            {
                b[i] = readInt("Enter b[" + i.ToString() + "] (integer):", anyInt);
            }
